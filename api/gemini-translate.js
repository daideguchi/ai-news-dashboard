...
${isLongContent ? 
        `記事の重要なポイントを箇条書きで3-5点に整理。各ポイントは1文で簡潔に具体的な内容を含めて要約してください。` :
        `要点を箇条書きで3つのポイントに整理。各ポイントは1文で簡潔にまとめてください。`
      }
...
2. 要約: 記事の重要なポイントを箇条書きで3-5点に整理。各ポイントは1文で簡潔に。` :
  `1. 翻訳: 自然で読みやすい日本語に翻訳
2. 要約: 要点を箇条書きで3つのポイントに整理。各ポイントは1文で簡潔に。`
}
